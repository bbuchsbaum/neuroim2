...
- Use `SparseNeuroVol` or `SparseNeuroVec` when a mask defines the
  stored voxel set, whether out-of-mask locations are outside the
  analysis support or simply implicit background zeros for your
  workflow.
...
- your downstream operations have clear semantics for absent voxels,
  such as outside-support values or implicit background zeros after
  densification
