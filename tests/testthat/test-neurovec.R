...
test_that("can concatenate two or more NeuroVecs", {
	dat <- array(0, c(64,64,64,4))
	spc <- NeuroSpace(c(64,64,64,4))
	bv1 <- DenseNeuroVec(dat, spc)
	bv2 <- DenseNeuroVec(dat, spc)
...
test.NeuroVec.as.matrix <- function() {
	dat <- array(rnorm(64*64*64*4), c(64,64,64,4))
	spc <- NeuroSpace(c(64,64,64,4))
	bv1 <- DenseNeuroVec(dat, spc)
	mat <- as.matrix(bv1)
...
test.SparseNeuroVec.as.sparse <- function() {
	dat <- array(rnorm(64*64*64*4), c(64,64,64,4))
	spc <- NeuroSpace(c(64,64,64,4))
	bv1 <- DenseNeuroVec(dat, spc)
...
test.SparseNeuroVec.concat <- function() {
	dat <- array(0, c(64,64,64,4))
	spc <- NeuroSpace(c(64,64,64,4))
	tmp <- rnorm(64*64*64)
	mask <- tmp > .8
